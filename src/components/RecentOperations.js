  ...
  operationTypeColRender(op) {
    switch (op.type) {
      ...
      case 'create_passive_offer':
        ...
        return <span>
          {action} {this.amount(op.amount, op.selling_asset_type, op.selling_asset_code, op.selling_asset_issuer)} for {op.buying_asset_type == "native" ? <i>HCX</i> : <AssetLink horizonURL={this.props.horizonURL} code={op.buying_asset_code} issuer={op.buying_asset_issuer} />}
        </span>;
      case 'account_merge':
